        ...
        <Section className="max-w-md flex flex-col justify-center items-center">
            ...
            >
                ...
                <div className="w-full flex flex-col">
                    ...
                    <TextInput name="full_name" id="full_name" required className="text-sm"/>
                </div>
                <div className="w-full flex flex-col">
                    <Label htmlFor="username" value="Username"/>
                    <TextInput name="username" id="username" required className="text-sm"/>
                </div>
                <div className="w-full flex flex-col">
                ...
                <div className="w-full">
                    <span className="text-tertiary text-xs">
                        <Link href="/login"
                              className={'text-primary dark:text-orange-600 hover:underline'}>Log in</Link> if you already have an account
                    </span>
                </div>
            </form>
        </Section>
